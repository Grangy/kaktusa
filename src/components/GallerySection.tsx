        ...
        >
          {photos.map((src, i) => (
            ...
            >
              ...
              >
                <div className={`relative aspect-[4/5] rounded-2xl transition-all duration-300 cursor-pointer ${i === activeIndex ? "shadow-[0_4px_24px_-4px_rgba(0,0,0,0.45),0_0_14px_-1px_rgba(145,145,145,0.67)]" : "shadow-[0_2px_12px_-4px_rgba(0,0,0,0.35)]"}`}>
      ...
      <AnimatePresence>
        {lightboxIndex !== null && (
          ...
          >
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-[0_25px_80px_-12px_rgba(0,0,0,0.8),1px_1px_14px_-1px_rgba(145,145,145,0.67)]">
                <Image
                  key={lightboxIndex}
