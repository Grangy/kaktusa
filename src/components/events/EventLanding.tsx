      ...
      <section className="py-16 md:py-24 px-6 md:px-12 border-t border-white/10">
        <div className={`${EVENT_CONTAINER} grid md:grid-cols-3 gap-6`}>
          <motion.div
            ...
            className="relative overflow-hidden text-center md:text-left p-6 rounded-2xl bg-white/5 shadow-[0_0_0_1px_rgba(255,255,255,0.06),0_4px_24px_-4px_rgba(0,0,0,0.5),0_0_36px_-8px_rgba(255,255,255,0.1)] transition-shadow duration-300"
          >
      ...
      <section id="tickets" className="py-16 md:py-24 px-6 md:px-12 scroll-mt-20">
        <div className={EVENT_CONTAINER}>
          ...
          <div className="space-y-4">
            {tickets.map((ticket, i) => (
              <motion.div
                ...
                className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 rounded-2xl bg-white/5 shadow-[0_0_0_1px_rgba(255,255,255,0.06),0_4px_24px_-4px_rgba(0,0,0,0.5),0_0_36px_-8px_rgba(255,255,255,0.1)]"
              >
                <div>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="mt-8 p-6 rounded-2xl bg-[var(--accent)]/5 flex items-start gap-3 shadow-[0_0_0_1px_rgba(255,255,255,0.06),0_4px_24px_-4px_rgba(0,0,0,0.5),0_0_36px_-8px_rgba(255,255,255,0.1)]"
          >
