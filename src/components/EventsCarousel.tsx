      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          {cards.map((event) => (
            ...
            >
              <div className="group relative block w-full rounded-3xl overflow-hidden transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_8px_32px_-8px_rgba(0,0,0,0.4),1px_1px_14px_-1px_rgba(145,145,145,0.67)] focus-within:ring-2 focus-within:ring-[var(--accent)]/30 focus-within:ring-offset-2 focus-within:ring-offset-[#080908] shadow-[0_4px_24px_-4px_rgba(0,0,0,0.45),1px_1px_14px_-1px_rgba(145,145,145,0.67)]">
                <TransitionLink
                  href={event.link}
                  className="block"
                >
