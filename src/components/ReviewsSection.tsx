      ...
      >
        {repeated.map((review, i) => (
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="flex-shrink-0 w-[280px] sm:w-[300px] md:w-[320px] p-6 rounded-2xl bg-white/5 shadow-[0_4px_24px_-4px_rgba(0,0,0,0.5),1px_1px_14px_-1px_rgba(145,145,145,0.67)] hover:shadow-[0_8px_32px_-8px_rgba(0,0,0,0.5),1px_1px_14px_-1px_rgba(145,145,145,0.67)] transition-all duration-200 min-h-[140px] flex flex-col snap-center"
          >
